...
export type CockroachDBClientOptions = ConstructorParameters<
  typeof PostgreSQLClient
>;

/** CockroachDB client */
export class ClientCockroachDB extends AbstractClient<PostgreSQLClient> {
  ...
  constructor(...params: CockroachDBClientOptions) {
